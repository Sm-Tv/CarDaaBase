package sm_tv.com.cardatabase.utils
...
class YUVtoRGB {
    ...
    private fun imageToByteBuffer(image: Image): ByteBuffer {
        ...
        for (planeIndex in 0..2) {
            ...
            val buffer: ByteBuffer = planes[planeIndex].buffer
            val rowStride: Int = planes[planeIndex].rowStride
            val pixelStride: Int = planes[planeIndex].pixelStride
